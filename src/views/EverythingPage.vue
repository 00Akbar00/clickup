<template>
  <div class="everything-page p-4">
    <div class="page-header mb-4">
      <h2 class="app-text-lg mb-2">Everything</h2>
      <p class="text-muted app-text mb-0">Overview of all teamspaces, projects, lists, and tasks</p>
    </div>
